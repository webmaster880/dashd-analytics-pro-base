...
- Admin UX: конструктор шорткодов, inline-редактирование raw data, импорт/экспорт словарей и raw data, унифицированные action-кнопки с защитой от конфликтов сторонних admin CSS.
