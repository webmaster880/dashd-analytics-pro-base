...
Если ссылка заполнена, frontend-легенда покажет флаг без обводки в круглой маске рядом с названием страны
...
Для отчетов с таблицей легенда вставляется сразу после блока графика, а таблица сдвигается ниже.
